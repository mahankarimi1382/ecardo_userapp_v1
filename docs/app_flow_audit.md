<!-- ============================================================
هدف فایل: نقشه کامل فلوهای اپ (Route Map + وضعیت کامل/ناقص هر صفحه) برای اپ کاربر eCardo (ecardo_user v1.0.26+26)
اقدام انجام‌شده: پیمایش 79 روت ثبت‌شده توسط ایجنت APP-SCAN در موج Task-10؛ بازرسی استاتیک همهٔ صفحات/کنترلرها/بایندینگ‌ها/سرویس‌های شبکه و FCM (بدون اجرای flutter/dart — فقط خواندن کد)
تاریخ: 2026-09-14 | وضعیت‌ها: ✅ کامل / ⚠️ ناقص / ❌ خالی یا کرش / 🔗 وابسته به ایجنت/مرچنت
============================================================ -->
