...
class _TravelCheckoutScreenState extends State<TravelCheckoutScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final hasBalance = controller.mainWalletBalance >= widget.total.amount;
    return TravelPage(
          ...
          child: Obx(
            () => CommonButton(
              ...
              backgroundColor: hasBalance
                  ...
                  : TravelTheme.green,
              textColor: widget.type == TravelProductType.esim && hasBalance
                  ? TravelTheme.ink
                  : Colors.white,
        ...
        children: [
          ...
          if (!hasBalance) ...[
            ...
            Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.info_outline_rounded, color: TravelTheme.red),
                  SizedBox(width: 10.w),
                  Expanded(
                    child: Text(
